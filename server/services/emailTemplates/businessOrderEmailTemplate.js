...
module.exports = (business, order) => {
    ...
    return `<body>` +
        ...
        `<p>Catering Order is currently awaiting your approval.</p>` +
        `<p>Payment has been authorized and will only be charged once order has been approved.</p>` +
        `<p>Click on the following link to view order. <a href="${keys.redirectDomain}/dashboard/order">Dashboard Link</a> \n\n</p>` +
        `<div >
        <h2>
